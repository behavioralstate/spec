...
- [ ] Upload the `-01` refresh — **prepared 2026-08-29** ([standards/draft-dinuzzo-best-protocol-01.md](standards/draft-dinuzzo-best-protocol-01.md), validated 0 errors/0 flaws, xml/txt rendered): IANA Considerations rewritten for the registration rejection; snapshot updated to spec 0.9.6 (workflows capability + `impact` annotation). Riccardo uploads the `.xml` at <https://datatracker.ietf.org/submit/>
