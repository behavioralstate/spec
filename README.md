...
|---|:---:|:---:|
| **Core Specification:** | | |
| [OAP Overview](specs/overview.md) | [v0.3.15](https://github.com/openagentprotocol/spec/blob/v0.3.15/specs/overview.md) | [WIP](specs/overview.md) |
| [Discovery](specs/discovery.md) | [v0.3.15](https://github.com/openagentprotocol/spec/blob/v0.3.15/specs/discovery.md) | [WIP](specs/discovery.md) |
| [Versioning](specs/versioning.md) | [v0.3.15](https://github.com/openagentprotocol/spec/blob/v0.3.15/specs/versioning.md) | [WIP](specs/versioning.md) |
| [Conformance](specs/conformance.md) | [v0.3.15](https://github.com/openagentprotocol/spec/blob/v0.3.15/specs/conformance.md) | [WIP](specs/conformance.md) |
| | | |
| **Agent Capabilities:** | | |
| [Registry](specs/agents/registry.md) | [v0.3.15](https://github.com/openagentprotocol/spec/blob/v0.3.15/specs/agents/registry.md) | [WIP](specs/agents/registry.md) |
| [Lifecycle](specs/agents/lifecycle.md) | [v0.3.15](https://github.com/openagentprotocol/spec/blob/v0.3.15/specs/agents/lifecycle.md) | [WIP](specs/agents/lifecycle.md) |
| [Events](specs/agents/events.md) | [v0.3.15](https://github.com/openagentprotocol/spec/blob/v0.3.15/specs/agents/events.md) | [WIP](specs/agents/events.md) |
| [Commands](specs/agents/commands.md) | [v0.3.15](https://github.com/openagentprotocol/spec/blob/v0.3.15/specs/agents/commands.md) | [WIP](specs/agents/commands.md) |
...
| [MCP](specs/transports/mcp.md) | [v0.3.15](https://github.com/openagentprotocol/spec/blob/v0.3.15/specs/transports/mcp.md) | [WIP](specs/transports/mcp.md) |
| [A2A](specs/transports/a2a.md) | [v0.3.15](https://github.com/openagentprotocol/spec/blob/v0.3.15/specs/transports/a2a.md) | [WIP](specs/transports/a2a.md) |

> The most recent stable release is [v0.3.15](https://github.com/openagentprotocol/spec/releases/tag/v0.3.15).
