...
|---|:---:|:---:|
| **Core Specification:** | | |
| [OAP Overview](specs/overview.md) | [v0.4.14](https://github.com/openagentprotocol/spec/blob/v0.4.14/specs/overview.md) | [WIP](specs/overview.md) |
| [Discovery](specs/discovery.md) | [v0.4.14](https://github.com/openagentprotocol/spec/blob/v0.4.14/specs/discovery.md) | [WIP](specs/discovery.md) |
| [Versioning](specs/versioning.md) | [v0.4.14](https://github.com/openagentprotocol/spec/blob/v0.4.14/specs/versioning.md) | [WIP](specs/versioning.md) |
...
| [Memory](specs/agents/memory.md) | [v0.4.14](https://github.com/openagentprotocol/spec/blob/v0.4.14/specs/agents/memory.md) | [WIP](specs/agents/memory.md) |
| | | |
| **Observability:** | | |
| ~~Tracing~~ | *(removed — see changelog)* | — |
| | | |
| **Transport Bindings:** | | |
| [REST](specs/transports/rest.md) | [v0.4.14](https://github.com/openagentprotocol/spec/blob/v0.4.14/specs/transports/rest.md) | [WIP](specs/transports/rest.md) |
| [MCP](specs/transports/mcp.md) | [v0.4.14](https://github.com/openagentprotocol/spec/blob/v0.4.14/specs/transports/mcp.md) | [WIP](specs/transports/mcp.md) |
| [A2A](specs/transports/a2a.md) | [v0.4.14](https://github.com/openagentprotocol/spec/blob/v0.4.14/specs/transports/a2a.md) | [WIP](specs/transports/a2a.md) |

> The most recent stable release is [v0.4.14](https://github.com/openagentprotocol/spec/releases/tag/v0.4.14).
